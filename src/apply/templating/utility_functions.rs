...
pub fn register_utility_functions(
    ...
    TemplateRegistry::register_function(
        ...
        "Utility Functions",
        vec![("value".to_string(), "any: The value to get the length of (string, array, or object)".to_string())],
    ...
    TemplateRegistry::register_function(
        ...
        "Lookup Functions",
        vec![
            ("type".to_string(), "string: The lookup type (currently only 'env' is supported)".to_string()),
