        ...
        Arc::new(|value, _args| {
            if value.is_undefined() || value.is_none() {
                JinjaValue::from(minijinja::Error::new(
                    ...
                    "abs filter received undefined or none value",
                ))
    ...
    TemplateRegistry::register_filter(
        ...
        Arc::new(|value, args| {
            if value.is_undefined() || value.is_none() {
                JinjaValue::from(minijinja::Error::new(
                    minijinja::ErrorKind::InvalidOperation,
                    "round filter received undefined or none value",
                ))
            } else {
    ...
    TemplateRegistry::register_filter(
        ...
        Arc::new(|value, args| {
            if value.is_undefined() || value.is_none() {
                JinjaValue::from(minijinja::Error::new(
                    minijinja::ErrorKind::InvalidOperation,
                    "ternary filter received undefined or none value",
                ))
    ...
    TemplateRegistry::register_filter(
        ...
        Arc::new(|value, args| {
            if value.is_undefined() || value.is_none() {
                JinjaValue::from(minijinja::Error::new(
                    minijinja::ErrorKind::InvalidOperation,
                    "float filter received undefined or none value",
                ))
            } else {
    ...
    TemplateRegistry::register_filter(
        ...
        Arc::new(|value, args| {
            if value.is_undefined() || value.is_none() {
                JinjaValue::from(minijinja::Error::new(
                    minijinja::ErrorKind::InvalidOperation,
                    "int filter received undefined or none value",
                ))
            } else {
    ...
    TemplateRegistry::register_filter(
        ...
        Arc::new(|value, args| {
            if value.is_undefined() || value.is_none() {
                JinjaValue::from(minijinja::Error::new(
                    minijinja::ErrorKind::InvalidOperation,
                    "log filter received undefined or none value",
                ))
            } else {
                let base_str = args
                    .first()
    ...
    TemplateRegistry::register_filter(
        ...
        Arc::new(|value, args| {
            if value.is_undefined() || value.is_none() {
                JinjaValue::from(minijinja::Error::new(
                    minijinja::ErrorKind::InvalidOperation,
                    "pow filter received undefined or none value",
                ))
            } else {
                let exp_str = args
                    .first()
    ...
    TemplateRegistry::register_filter(
        ...
        Arc::new(|value, _args| {
            if value.is_undefined() || value.is_none() {
                JinjaValue::from(minijinja::Error::new(
                    minijinja::ErrorKind::InvalidOperation,
                    "sqrt filter received undefined or none value",
                ))
            } else {
                let s = value.to_string();
                if let Ok(num) = s.parse::<f64>() {
    ...
    TemplateRegistry::register_filter(
        ...
        Arc::new(|value, args| {
            if value.is_undefined() || value.is_none() {
                JinjaValue::from(minijinja::Error::new(
                    minijinja::ErrorKind::InvalidOperation,
                    "range filter received undefined or none value",
                ))
            } else {
